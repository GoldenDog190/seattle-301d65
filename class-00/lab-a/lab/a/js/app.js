...
function displayPics(){
  ...
  // The reason why the 38th line of code threw an error when we changed from var to let is because the console.log was outside of the block that was created when using let, instead of var. When using let, you must have all of the code within the block, otherwise it won't run and get confused by the console.log outside of the block. 
  console.log(viewed);
